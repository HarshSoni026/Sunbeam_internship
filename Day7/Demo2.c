// Code to Accept directory path as command-line argument
...
char directory_path[1024];   // Global variable to store directory path
...
void send_directory_listing(int client_fd) {
    ...
    d = opendir("/home/sayli/Sunbeam_internship/Day7");  // Use command-line path
    if (d) {
...
int main(int argc, char *argv[])
{
    ...
    directory_path[sizeof(directory_path) - 1] = '\0';  // Null terminate
